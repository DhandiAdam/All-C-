...
class Stack {
    ...
    public:
        ...
        void display() {
            ...
            for (int i = top; i >= 0; i--) {
                cout << "|";
                cout << setw(9) << left << data[i].nama << "|";
                cout << setw(12) << left << data[i].alamat << "|";
                cout << setw(12) << right << data[i].tgl_lahir << "|";
                cout << setw(13) << right << data[i].telp << "|";
                cout << endl;
            }
        }
};
...
int main() {
    ...
    do {
        cout << "============================" << endl;
        cout << "Program Penghapusan Data Karyawan" << endl;
        cout << "============================" << endl;
