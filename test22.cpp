...
void displayTickets() {
    if (head == NULL) { //head yang merupakan pointer ke elemen pertama dalam linked list.
        cout << "Belum ada tiket yang ditambahkan." << endl;
        return;
	//Penggunaan if dan NULL: Pada baris pertama fungsi, dilakukan pengecekan apakah head bernilai NULL, yang menandakan bahwa linked list kosong
	//Jika kondisi ini terpenuhi, maka akan ditampilkan pesan bahwa belum ada tiket yang ditambahkan, dan fungsi akan diakhiri dengan pernyataan return
    }
    ...
    cout << "|==========================|================================|" << endl;
        current = current->next;
		//dilakukan pemindahan current ke elemen berikutnya dalam linked list dengan menetapkan nilai current->next ke variabel current.
    }
}
...
void searchTicket(string intan_tujuan) {
    ...
    while (current != NULL) {
        if (current->intan_tujuan == intan_tujuan) {
            cout << "Tiket Kamu ditemukan!" << endl;
            cout << "Tujuan: " << current->intan_tujuan << endl;
            cout << "Jumlah Barang: " << current->siti_Jumlah << endl;
            cout << "Harga Total: Rp " << current->siti_harga << endl;
            return;
...
int main() {
    ...
    cout << "|                                                                      |" <<endl;
    cout << "|======================================================================|" <<endl;
    cout << "| 1. Palembang                         |    Rp 500.000                 |" <<endl;
    cout << "| 2. Medan                             |    Rp 700.000                 |" <<endl;
    cout << "| 3. Surakarto                         |    Rp 800.600                 |" <<endl;
    cout << "| 4. Jawa Tengah                       |    Rp 540.800                 |" <<endl;
