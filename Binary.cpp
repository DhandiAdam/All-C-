   ...
   KELAS : ASD B */	
	...
	int main()
	{
		...
		cout << endl;
		cout << " <<=============================================>> " << endl;
		cout << " <<<=========== Input Elemen Daun ==============>> " << endl;
		cout << " <<=============================================>> " << endl;
		cout << endl;
		cout << " <<== Masukkan Elemen Daun (Maksimum 6) == >> " << endl;
		for ( int i = 0; i<6; i++)
		{
			cout << " Masukkan Elemen Daun Ke- " << i+1 << " : ";cin >> Daun[i]; 
		}
		inserturutnomer(Daun);
		cout << " <<=====================================>> " << endl;
		cout << " << ==Pohon biner hasil pembecaan urut nomer == >> " << endl;
		cout << " <<=====================================>> " << endl;
		BacaUrutNomer();
		return 0;
		cin.get();
